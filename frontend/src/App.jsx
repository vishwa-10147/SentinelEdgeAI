...
// AnalyticsPanel moved to separate lazily-loaded component
  ...
  return (
    <div className="soc-app">
      ...
      <main className="dashboard-shell">
        ...
        <Suspense fallback={<div style={{padding:20,color:'#94a3b8'}}>Loading analytics…</div>}>
          <AnalyticsPanel timeline={timeline} alerts={alerts} devices={devices} onSeverityFilter={setFilter} onSelectDevice={(id)=>{ setSelected(id); topologyApi?.zoomToDevice?.(id) }} />
        </Suspense>
      </main>
      {selected && (
